...
export default {
  translation: {
    ...
    'modules-section-details-schedule': 'Schedule',
    ...
    'module-1-details-creations': 'Three pencil still lifes and one in charcoal',
    'module-1-details-length': 'One 2 to 3 hour class every week for 3 months',
    'module-1-details-schedule': 'Every Saturday at 10 AM starting March 21nd, 2020, or',
    'module-1-details-schedule-2': 'Every Tuesday at 5 PM starting March 24nd, 2020',
    'module-1-details-price': '$500 (groups) and $750 (private)',
    ...
    'module-1-summary-p3': 'The aim of this first module is therefore to familiarize the student with the basic notions of perspective, spatial construction and the behavior of monochrome light. It invites the student to hone these skills by creating a series of still lifes according to an effective teaching methodology. The final lessons lay the groundwork for the following module by introducing the first elements of the human form.',
    ...
    'module-2-details-creations': 'Two still lifes in oil, and one still life and one landscape in watercolor',
    'module-2-details-length': 'One 2 to 3 hour class every week for 3 months',
    'module-2-details-schedule': 'Every Sunday at 10 AM starting March 22rd 2020',
    'module-2-details-price': '$500 (groups) and $750 (private)',
    ...
    'workshop-1-summary-p1': 'In this first animal anatomy workshop we will get acquainted with three of the animals probably the most often represented in figurative art: cats, dogs and horses. The lessons will take the form of a blackboard presentation and the student will be invited to reproduce the diagrams in their notebooks. Prior knowledge of human anatomy is preferable, but is not required.',
    ...
    'info-contact-coordinates': 'The studio is located in Montreal at the corner of Masson and de Bordeaux.',
    'info-contact-contact': 'To register for courses or for any other information, you may reach me at the following:',
    'info-contact-insta': 'You can also follow me on ',
